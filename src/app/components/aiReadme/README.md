...
> 📖 **[Interactive Documentation Portal](docs/index.html)** • [Quickstart](docs/getting-started/quickstart.md) • [API Reference](docs/api-reference/python-api.md) • [Hosting Guide](docs/deployment/hosting-guide.md)
...
│
├── docs/                              # Production documentation suite & static portal
│   ├── index.html                     # Standalone interactive documentation web app
│   ├── index.md                       # Documentation homepage & sitemap
│   ├── ML_STATUS.md                   # Full component maturity and validation log
│   ├── assets/                        # Stylesheets & client-side app logic
│   │   ├── style.css                  # Responsive dark/light theme stylesheet
│   │   └── app.js                     # Search, simulator & corridor map logic
│   ├── getting-started/               # Quickstart & architecture guides
│   ├── core-engine/                   # Telemetry, ML, decision engine, CP-SAT & planning
│   ├── benchmarks/                    # AI vs. FIFO empirical validation
│   ├── api-reference/                 # Python API & data contract schemas
│   └── deployment/                    # Multi-platform site hosting guide
│
├── .github/workflows/                 # Automated CI/CD pipelines
│   └── deploy-docs.yml                # GitHub Pages automated deployment
├── vercel.json                        # Vercel instant deployment manifest
├── netlify.toml                       # Netlify instant deployment manifest
├── Dockerfile.docs                    # Production Nginx container for documentation
├── nginx.docs.conf                    # Nginx server routing & security config
...
Railway AI includes a complete static documentation portal and technical guides ready for immediate deployment:

- **[Interactive Documentation Web App](docs/index.html)**: Zero-dependency web application with live search, dark/light mode, an **Interactive Decision & CP-SAT Simulator**, and an **Interactive NDLS–MMCT Corridor Map**.
- **[System Architecture Guide](docs/getting-started/architecture.md)**: 38-phase matrix, data flow, and separation of synthetic vs. real telemetry.
- **[Corridor Telemetry & RailKit](docs/core-engine/corridor-telemetry.md)**: Live train tracking, station aliases (`JHS` ➔ `VGLJ`, etc.), and delay pressure scoring.
- **[Failure Risk Modeling](docs/core-engine/failure-prediction.md)**: Calibrated XGBoost risk classifier (PR-AUC tuned, threshold `0.35`), RUL, and Cox survival analysis.
- **[Decision Engine Formulation](docs/core-engine/decision-engine.md)**: 7-factor weighted scoring, decision categories, and explainable reason tags.
- **[CP-SAT Optimizer](docs/core-engine/cpsat-optimizer.md)**: Discrete interval formulation, track non-overlap, and manpower capacity.
- **[Multi-Horizon Planning](docs/core-engine/multi-horizon-planning.md)**: 6h daily, 7d weekly, 30d monthly, rolling lookahead, and dynamic rescheduling.
- **[AI vs. FIFO Benchmark](docs/benchmarks/ai-vs-fifo.md)**: Quantitative proof of superiority (+25% critical throughput, 40%+ block bundling).
- **[Python API Reference](docs/api-reference/python-api.md)**: Complete `RailwayMLEngine` method and parameter reference.
- **[Data Contracts & Schemas](docs/api-reference/data-contracts.md)**: Schemas for corridor geometry, work orders, and microservices.
- **[Site Hosting & Deployment Guide](docs/deployment/hosting-guide.md)**: Step-by-step instructions for Vercel, Netlify, GitHub Pages, Cloudflare Pages, Docker/Nginx, and MkDocs.

```bash
# Preview the documentation locally right now
